...
public class CommonVar {
	...
	public static final String WORKERCSEIP = "192.168.1.140";
	public static final int WORKERCSEPORT = 8181;
	public static final String WORKERCSEID = "worker-1-id";
	public static final String WORKERCSENAME = "worker-1";
	
	public static final String AENAME = "WorkerAE";
	public static final String AEPROTOCOL="http";
	public static final String AEIP = "192.168.1.140";
